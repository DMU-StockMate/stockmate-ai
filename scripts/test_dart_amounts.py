...
AMOUNT_CASES = [
    ...
    (
        "행 끝의 집계 칸('계')은 앞의 진짜 라벨을 물려받는다 - 수량이면 건너뛴다",
        "단위 : 백만원 취득금액 수량 비율 보통주식 1,625,769 0.2 92,683 "
        "- - - 1,625,769 0.2 92,683 계 1,625,769",
        [],
        ["1,625,769(약"],
    ),
    (
        "집계 칸이 금액 라벨을 물려받으면 환산은 그대로 붙는다",
        "단위 : 백만원 매출액 1,234,567 2,345,678 계 3,580,245",
        ["3,580,245(약 3.58조원)"],
        [],
    ),
    (
